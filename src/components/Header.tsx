  ...
  return (
    <header className="w-full h-15 flex flex-row flex-nowrap justify-between items-center px-4 shadow-md bg-transparent z-10 relative">
      ...
      <div className="flex flex-row flex-nowrap items-center">
        {showBackButton && (
          <button 
            className="p-1 mr-2.5 flex items-center justify-center bg-transparent border-none cursor-pointer hover:opacity-80 transition-opacity" 
        ...
        <h1 className="text-lg font-semibold m-0 text-black whitespace-nowrap">{title}</h1>
      </div>
      ...
      <div className="flex flex-row flex-nowrap items-center gap-2.5">
        ...
        {showSettingsIcon && (
          <button 
            className="bg-transparent border-none cursor-pointer p-1 flex items-center justify-center hover:opacity-80 transition-opacity"
            aria-label="Settings"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
