...
const coffeeData: Drink[] = [
  {
    ...
    name: 'Эспрессо',
    price: 79,
    image: `${process.env.PUBLIC_URL}/images/products/espresso.png`,
    category: 'coffee',
  },
  {
    id: 2,
    name: 'Эспрессо 2x',
    price: 109,
    image: `${process.env.PUBLIC_URL}/images/products/double-espresso.png`,
    category: 'coffee',
  },
  {
    id: 3,
    name: 'Американо',
    price: 119,
    image: `${process.env.PUBLIC_URL}/images/products/americano.png`,
    category: 'coffee',
  },
  {
    id: 4,
    name: 'Латте',
    price: 129,
    image: `${process.env.PUBLIC_URL}/images/products/latte.png`,
    category: 'coffee',
  },
  {
    id: 5,
    name: 'Капучино',
    price: 129,
    image: `${process.env.PUBLIC_URL}/images/products/cappuccino.png`,
    category: 'coffee',
  },
  {
    id: 6,
    name: 'Макиато',
    price: 129,
    image: `${process.env.PUBLIC_URL}/images/products/macchiato.png`,
    category: 'coffee',
  },
];
...
const teaData: Drink[] = [
  {
    ...
    name: 'Чёрный чай',
    price: 69,
    image: `${process.env.PUBLIC_URL}/images/products/tea-black.png`,
    category: 'tea',
  },
  {
    id: 8,
    name: 'Зелёный чай',
    price: 69,
    image: `${process.env.PUBLIC_URL}/images/products/tea-green.png`,
    category: 'tea',
  },
  {
    id: 9,
    name: 'Чай с мятой',
    price: 79,
    image: `${process.env.PUBLIC_URL}/images/products/tea-mint.png`,
    category: 'tea',
  },
  {
    id: 10,
    name: 'Чай с имбирём',
    price: 79,
    image: `${process.env.PUBLIC_URL}/images/products/tea-ginger.png`,
    category: 'tea',
  },
];
...
const milkshakeData: Drink[] = [
  {
    ...
    price: 129,
    image: `${process.env.PUBLIC_URL}/images/products/milkshake-vanilla.png`,
    category: 'milkshake',
  },
  {
    id: 12,
    ...
    price: 129,
    image: `${process.env.PUBLIC_URL}/images/products/milkshake-chocolate.png`,
    category: 'milkshake',
  },
  {
    id: 13,
    ...
    price: 129,
    image: `${process.env.PUBLIC_URL}/images/products/milkshake-strawberry.png`,
    category: 'milkshake',
  },
];
...
const softDrinksData: Drink[] = [
  {
    ...
    price: 89,
    image: `${process.env.PUBLIC_URL}/images/products/soft-drink-cranberry.png`,
    category: 'softDrink',
  },
  {
    id: 15,
    name: 'Лимонад',
    price: 99,
    image: `${process.env.PUBLIC_URL}/images/products/soft-drink-lemonade.png`,
    category: 'softDrink',
  },
  {
    id: 16,
    ...
    price: 69,
    image: `${process.env.PUBLIC_URL}/images/products/soft-drink-soda.png`,
    category: 'softDrink',
  },
];
